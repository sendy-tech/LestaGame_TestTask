...
Переменные окружения (добавлено после фидбека):

APP_PORT - Порт, на котором будет доступно приложение на хосте<br />
POSTGRES_USER - пользователь БД<br />
POSTGRES_PASSWORD - пароль для подключения к БД<br />
POSTGRES_DB - имя БД <br />
POSTGRES_PORT - порт подключения БД<br />
DATABASE_URL - URL подключения к БД<br />
DATABASE_HOST - хост БД<br />
SECRET_KEY - ключ для аутентификации<br />
